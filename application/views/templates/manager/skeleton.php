...
<nav class="navbar bg-green">
	<ul class="navmenu">
            <li><a href="<?php echo base_url('admin/manage'); ?>"><i class="fa fa-home"></i></a></li>
            <li><a href="<?php echo base_url('admin/manage/theme'); ?>">Theme</a></li>
            <li><a href="<?php echo base_url('admin/manage/content'); ?>">Content</a></li>
            <li>Configuration<ul>
                    <li><a href="<?php echo base_url('admin/manage/options'); ?>">Options</a></li>
                    <li><a href="<?php echo base_url('admin/manage/users'); ?>">Users</a></li>
                </ul>
            </li>
            <li><a href="<?php echo base_url('admin/manage/logout'); ?>">Logout</a></li>
	</ul>
</nav>
